...
if __name__ == "__main__" :
    ...
    dirr = gettempdir() + '/uploads/result.mp4v'

    vid_writer = cv2.VideoWriter(dirr.format(str(source).split(".")[0]),cv2.VideoWriter_fourcc(*'XVID'), 15, (frame.shape[1],frame.shape[0]))
